...
# cuando se crea el cliente //db debe coincidir con el nombre que se definión en el docker-compose.yml
client = MongoClient("mongodb://db:27017")

#Step 1: create a DB
db = client.aNewDB

# Step 2: create a collection named UserNum
UserNum = db["UserNum"]

# Step 3: insert a document to keep track of the numbers of user who visits the website
UserNum.insert({
    'num_of_users':0
})
